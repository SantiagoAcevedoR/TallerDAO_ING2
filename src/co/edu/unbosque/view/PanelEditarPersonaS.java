...
public class PanelEditarPersonaS extends JPanel{
	
	private final String COMANDO_CREAR = "CREAR2123912";
	private final String COMANDO_VOLVER = "VOLVER2012233";
	...
	public PanelEditarPersonaS() {
		setBorder(new TitledBorder("Editar persona arreglo"));
		...
		this.btnVolver.setActionCommand(COMANDO_VOLVER);
		this.btnCrear = new JButton("Editar");
	...
	public void obtenerDatos(String[] entradas) {
		txtNombre.setText(entradas[3]);
		txtApellido.setText(entradas[4]);
		txtTelefono.setText(entradas[5]);
		txtEdad.setText(entradas[1]);
		txtCedula.setText(entradas[6]);

...
public class PanelAgregarPersonaB extends JPanel{
	
	private final String COMANDO_CREAR = "CREAR00";
	private final String COMANDO_VOLVER = "VOLVER00";
	...
	public PanelAgregarPersonaB() {
		setBorder(new TitledBorder("Registro de persona a binario"));
